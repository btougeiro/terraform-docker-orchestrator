...
Please do not mistake the examples provided as "best practices". It is up to users to consult the Docker documentation for best practices, usage recommendations, etc.
