...
| Name | Type |
|------|------|
| [docker\_service.this](https://registry.terraform.io/providers/kreuzwerker/docker/latest/docs/resources/service) | resource |
...
| Name | Description |
|------|-------------|
| <a name="output\_services"></a> [services](#output\\_services) | A map of service objects managed by this sub-module. |
<!-- END\_TF\_DOCS -->
